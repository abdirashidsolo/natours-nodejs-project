...
exports.saveResetPassword = exports.logout = exports.login = exports.forgotPassword = exports.addlikedTours = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(username, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          document.cookie = "jwt=".concat(res.data.token, "; max-age=10080min");
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Password reset link sent to the email');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var saveResetPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(password, passwordConfirm, id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "/api/v1/users/saveResetPassword/".concat(id),
            data: {
              password: password,
  ...
  return function saveResetPassword(_x4, _x5, _x6) {
...
var addlikedTours = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(liked, id) {
    var res, message;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "/api/v1/users/liked/".concat(id),
            data: {
              liked: liked
            },
            withCredentials: true
        ...
        case 3:
          res = _context5.sent;
          if (liked === 'add') message = 'Tour added your favourite';else message = 'Tour removed your favourite';
          if (res.data.status === 'success') {
  ...
  return function addlikedTours(_x7, _x8) {
    return _ref5.apply(this, arguments);
  };
}();
exports.addlikedTours = addlikedTours;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NsQP3LXBw8GLfrPsorvnsSy4YqMZqumHJ3qOydRwHn2QSw6A9CHAxpp5YDPT2zNZx5YzW7j91pF0d1gnBHeRQs0006dzFbWet');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', _context.t0.massage);
        case 11:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Signup sended!');
            window.setTimeout(function () {
...
var saveResetForm = document.querySelector('.saveReset-form');
var likedHeart = document.querySelector('.detail__heartIcon');
var favouriteBtn = document.querySelector('.header__favourite');
...
if (userDataForm) {
  document.getElementById('photo').addEventListener('change', function (e) {
    e.preventDefault();
    var imgUrl = URL.createObjectURL(document.getElementById('photo').files[0]);
...
if (forgotForm) forgotForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.querySelector('#emailForgot').value;
  console.log(email);
  (0, _login.forgotPassword)(email);
});
if (saveResetForm) document.querySelector('.form--saveReset').addEventListener('submit', function (e) {
  e.preventDefault();
  var id = document.querySelector('#saveResetBtn').dataset.userId;
  console.log(id);
  var password = document.querySelector('#resetPassword').value;
  var passwordConfirm = document.querySelector('#resetPasswordConfirm').value;
  (0, _login.saveResetPassword)(password, passwordConfirm, id);
});

// Like and Unlike implementations

if (likedHeart) {
  likedHeart.addEventListener('click', function (e) {
    e.preventDefault();
    console.log(likedHeart.dataset.like);
    var id = likedHeart.dataset.id;
    if (likedHeart.dataset.like === 'unlike') (0, _login.addlikedTours)('add', id);else (0, _login.addlikedTours)('remove', id);
  });
}
