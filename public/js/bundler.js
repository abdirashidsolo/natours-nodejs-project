...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
    ...
    '../../node_modules/core-js/modules/es6.math.hypot.js': [
      function (require, module, exports) {
        // 20.2.2.17 Math.hypot([value1[, value2[, ΓÇª ]]])
        var $export = require('./_export');
        var abs = Math.abs;
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        _context.next = 3;
                        return (0, _axios.default)(
                          'http://127.0.0.1:8000/api/v1/bookings/checkout-session/'.concat(
                            tourId
                          )
                        );
                      case 3:
                    ...
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          passwordConfirm =
                            document.getElementById('password-confirm').value; // console.log({ passwordCurrent, password, passwordConfirm });
                          _context.next = 7;
